...
app.use('/uploads', express.static('C:/quartosemestre/DigitalMenuBack/Digital-Menu-back-end/uploads')); // esse e o caminho q a imagem vai ficar salva, se quiserem trocar tem que mudar aqui
app.use(cors());
